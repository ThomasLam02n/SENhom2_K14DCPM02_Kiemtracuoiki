...
public class BootStrapReceptionSixsenses {
    private static BookedRoom bookedRoom = new BookedRoom("SIXSENSESBOOKEDROOMS.json");
    private static Bill bill = new Bill("SIXSENSESBILLS.json");
